...
1. **Clone the repository**
   ```bash
   git clone https://github.com/omarhany04/NASA-Center
   cd NASA-Center
   ```
...
NASA provides a generous free tier for these APIs (1,000 requests per hour). Get your API key at [https://api.nasa.gov/](https://api.nasa.gov/).
